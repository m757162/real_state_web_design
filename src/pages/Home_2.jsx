    ...
    <>
      ...
      <div className="container-fluid">
        <div className="row row bg-body-tertiary">
          <div className="col hero-img-bg vh-100 ">
            <div className="hero-content">
              <HeroText />

              <div className="row justify-content-center">
                <div className="col-lg-9">
                  <div className="p-4 theme-border d-flex flex-column flex-md-row  gap-3 bg-body rounded-2">
                    <ReactSelect />
              ...
              <div className="d-flex  justify-content-center gap-3 my-5 hero-cnt-blur">
                <div className="">
